...
def add_mockup_data(cls):
    ...
    professor_user2 = User(google_uid="88888", email="professor2@gmail.com", type="Professor")
    ...
    professor_user3 = User(google_uid="99999", email="professor3@gmail.com", type="Professor")
